                ...
                <div class="bg-white rounded-4 shadow-sm p-4">
                    ...
                    <div class="text-center mb-4">
                        <div class="d-flex align-items-center justify-content-center gap-2">
                            <a href="{{ route('dashboard.index') }}"><img src="{{ asset('dashboard-assets/images/logo.png') }}" alt="logo"></a>
                        </div>
                    </div>
                    ...
                    <form>
                        ...
                        <div class="mb-4 position-relative">
                            ...
                            <div class="position-relative">
                                <input type="password" class="form-control form-control-lg rounded-3" placeholder="••••••••" id="password">
                        ...
                        <div class="text-center text-muted mb-4 text-size-14">
                            You have an account? <a href="{{ route('login-dash') }}" class="text-primary">Login</a>
                        </div>
                    </form>
                </div>
            </div>
